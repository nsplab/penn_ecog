...
public:
    ...
    reachStateEquation(size_t maxTimeSteps, size_t reachTimeSteps, arma::mat reachTarget, size_t dim = 3, double diagQ=1.0e-3, double finalPosCov=1.0e-6, double finalVelCov=1.0e-8);
