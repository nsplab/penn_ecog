...
def _filter_correct(observation_matrix, observation_covariance,
    ...
    return (predicted_observation_mean, predicted_observation_covariance, kalman_gain, corrected_state_mean,
            corrected_state_covariance)
...
def _filter(transition_matrices, observation_matrices, transition_covariance,
    ...
    predicted_observation_means = np.zeros((n_timesteps, n_dim_obs))
    predicted_observation_covariances = np.zeros((n_timesteps, n_dim_obs, n_dim_obs))
    ...
    for t in range(n_timesteps):
        ...
        observation_offset = _last_dims(observation_offsets, t, ndims=1)
        (predicted_observation_means[t], predicted_observation_covariances[t], kalman_gains[t], filtered_state_means[t],
...
class KalmanFilter(object):
    ...
    def filter_update(self, filtered_state_mean, filtered_state_covariance,
        ...
        (predicted_observation_mean, predicted_observation_covariance, kalman_gain, next_filtered_state_mean,
        ...
        return (predicted_observation_mean, predicted_observation_covariance, next_filtered_state_mean, next_filtered_state_covariance, kalman_gain)
